...
#define BRUNSLI_INTEL_VERSION                                          \
  BRUNSLI_MAKE_VERSION(__INTEL_COMPILER / 100, __INTEL_COMPILER % 100, \
...
#define BRUNSLI_SUNPRO_VERSION                                           \
  BRUNSLI_MAKE_VERSION((__SUNPRO_C >> 8) & 0xf, (__SUNPRO_C >> 4) & 0xf, \
                       (__SUNPRO_C) & 0xf)
...
#define BRUNSLI_SUNPRO_VERSION                                             \
  BRUNSLI_MAKE_VERSION((__SUNPRO_CC >> 8) & 0xf, (__SUNPRO_CC >> 4) & 0xf, \
                       (__SUNPRO_CC) & 0xf)
#endif
...
#define BRUNSLI_IBM_VERSION                                  \
  BRUNSLI_MAKE_VERSION(__ibmxl_version__, __ibmxl_release__, \
...
#define BRUNSLI_IAR_VERSION                                          \
  BRUNSLI_MAKE_VERSION((__VER__ / 1000000), (__VER__ / 1000) % 1000, \
                       (__VER__ % 1000))
#else
...
#define BRUNSLI_PUBLIC
    ...
    !defined(__STDC_NO_VLA__) && !defined(__cplusplus) && !defined(__PGI) && \
    !defined(__PGIC__) && !defined(__TINYC__)
